> **GrowwithMH fork.** Self-host setup, VPS deployment, and what was changed
> from upstream: [`GROWWITHMH.md`](./GROWWITHMH.md). The rest of this README is
> upstream's, kept as-is so updates merge cleanly.
